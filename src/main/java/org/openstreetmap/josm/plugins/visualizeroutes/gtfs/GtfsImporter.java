...
import org.openstreetmap.josm.plugins.visualizeroutes.gtfs.gui.GtfsLayer;
import org.openstreetmap.josm.plugins.visualizeroutes.gtfs.readers.GtfsReadException;
...
public class GtfsImporter extends FileImporter {
    ...
    public void importData(File file, ProgressMonitor progressMonitor) throws IOException, IllegalDataException {
        try {
            FileSystem zip = FileSystems.newFileSystem(file.toPath(), (ClassLoader) null);
