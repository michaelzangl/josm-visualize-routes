...
public class StopAreaTabManager extends AbstractTabManager<StopAreaGroupPanel> {
    ...
    public StopAreaTabManager(EnhancedRelationEditorAccess editorAccess) {
        super(editorAccess);
    }

    @Override
    protected AbstractTabManager.TabAndDisplay<StopAreaGroupPanel> getTabToShow(EnhancedRelationEditorAccess editorAccess) {
