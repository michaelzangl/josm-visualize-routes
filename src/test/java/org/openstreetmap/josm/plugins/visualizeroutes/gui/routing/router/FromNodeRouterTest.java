...
public class FromNodeRouterTest {
    ...
    public void testFindRouteTargetsSimpleLine() {
        DataSet ds = null; // TODO: importOsmFile(getClass().getResourceAsStream("/router/find-route-targets-simple-line.xml"), "testLayer");
    ...
    public void testFindRouteTargetsAccessRestrictions() {
        DataSet ds = null; // TODO: importOsmFile(getClass().getResourceAsStream("/router/find-route-targets-access-restrictions.xml"), "testLayer");
